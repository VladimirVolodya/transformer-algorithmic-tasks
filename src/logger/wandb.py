    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            # Offline mode logs locally and needs no credentials. Only attempt
            # login when going online; the API key must come from `wandb login`
            # or the WANDB_API_KEY env var -- never hardcode or commit it.
            if mode != "offline":
                wandb.login()
